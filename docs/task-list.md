...
- [ ] **T01** Create `index.html` with all CDN script tags in correct load order. Mount empty React app to `#root`. Verify it renders "rocket-claude loading…" in the browser with no console errors.
