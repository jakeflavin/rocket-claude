import { Center, VStack, Heading, Caption, Icon, Button } from './ui'
    ...
    <Center className="h-full">
      <VStack gap="gap-6" className="items-center text-center px-6 max-w-md">
        ...
        <VStack gap="gap-2" className="items-center">
          ...
          <Caption className="leading-relaxed">
            Make sure the app is served via HTTP (<span className="font-mono text-muted">npm run dev</span>) and that <span className="font-mono text-muted">data/transactions.csv</span> exists.
          </Caption>
        </VStack>
        {onRetry && (
