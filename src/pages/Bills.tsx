...
import {
  Box, VStack, HStack, Grid, Skeleton, EmptyState, PageHeader, Stat, RecurringDonut,
} from '../components/ui'
import { useCategoryColorMap } from '../context/SettingsContext'
...
import type { ChartSlice } from '../components/ui'
...
export function Bills() {
  ...
  const billSlices = useMemo<ChartSlice[]>(() =>
    billGroups
